        ...
        else
        {
            lock (dal ?? throw new DalApi.NullObject())
            {
             ...
             (c ?? throw new BlApi.BlNOtImplementedException()).FinalPrice
                 += ((c ?? throw new BlApi.BlNOtImplementedException()).Items ?? throw new BlApi.BlNOtImplementedException())[idx].ItemPrice * (quantity - (((c ?? throw new BlApi.BlNOtImplementedException()).Items ?? throw new BlApi.BlNOtImplementedException())[idx].Amount));
